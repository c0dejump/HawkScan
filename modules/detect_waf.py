...
def verify_waf(req, res, user_agent, tests):
    ...
    #ASP.NET
        ...
        return True
    #ASTRA
    elif "our website protection system has detected an issue with your IP address and wont let you proceed any further" in req_test.text or \
    ...
    #Immunify360 
        ...
        return True
    #IndusGuard
    elif "further investigation and remediation with a screenshot of this page" in req_test.text:
