...
def resume_options(url, thread, wordlist, recur, js, exclude, proxy, header, backup):
    """
...
\033[31m___________________________________________________________________\033[0m
    """.format(url, header_, thread, wordlist, recur_, js_, backup_, exclude_, "\033[32mTrue\033[0m" if proxy else "\033[31mFalse\033[0m"))